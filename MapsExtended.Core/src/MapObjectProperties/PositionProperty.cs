...
namespace MapsExt.Properties
{
	public class PositionProperty : ValueProperty<Vector2>, ILinearProperty<PositionProperty>
	{
		...
		public static PositionProperty operator *(PositionProperty a, float b) => new(a.Value * b);
		public static PositionProperty operator *(RotationProperty a, PositionProperty b) => new(a.Value * b.Value);
		public static PositionProperty operator +(PositionProperty a, PositionProperty b) => new(a.Value + b.Value);
		public static PositionProperty operator -(PositionProperty a, PositionProperty b) => new(a.Value - b.Value);
	}
